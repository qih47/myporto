...
var LIBRARY_LABEL = `google-genai-sdk/2.3.0`;
...
function addOutputProperties(interaction) {
	...
	while (firstTrailing > 0 && steps[firstTrailing - 1].type === "model_output") firstTrailing--;
	const output = steps.slice(firstTrailing).flatMap((step) => {
		var _a;
		return (_a = step.content) !== null && _a !== void 0 ? _a : [];
	});
	const textParts = [];
